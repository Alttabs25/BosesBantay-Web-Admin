        ...
        <div className="w-full max-w-sm text-white">
          ...
          {step === 'email' ? (
            ...
            <form onSubmit={resetPassword} className="space-y-5">
              ...
              <div className="block">
                <label htmlFor="forgot-new-password" className="mb-1.5 block text-sm font-semibold">
                  Bagong Password
                </label>
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••••"
                    className="w-full rounded-lg border-0 bg-white pl-4 pr-11 py-2.5 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white"
                  />
                  <button
                    type="button"
              ...
              <div className="block">
                <label htmlFor="forgot-confirm-password" className="mb-1.5 block text-sm font-semibold">
